...
static int output_select_apply(struct oxygen *chip)
{
	...
	/*
	 * Custom modification to force the headphone amplifier ON
	 * and route the output to the REAR jack.
	 * This combines the logic from PLAYBACK_DST_HP_FP (amp on)
	 * and PLAYBACK_DST_HP (rear jack).
	 */

	// Step 1: Route the DAC output to the amplifier
	data->cs4245_shadow[CS4245_SIGNAL_SEL] &= ~CS4245_A_OUT_SEL_MASK;
	data->cs4245_shadow[CS4245_SIGNAL_SEL] |= CS4245_A_OUT_SEL_DAC;

	// Step 2: Route the signal to the REAR headphone jack
